...
import com.elt.framework.library.http.query.JsonQueryBuilder;
...
public class HttpConfig {
    ...
    protected HttpConfig setLiteHttp(EltHttp liteHttp) {
    ...
    public HttpConfig setDefaultCacheDir(String defaultCacheDir) {
        ...
        if (!file.exists()) {
            ...
            Elog.i(TAG, file.getAbsolutePath() + "  mkdirs: " + mkdirs);
        }
        Elog.i(TAG, "lite http cache file dir: " + defaultCacheDir);
        return this;
    }
