package com.elt.framework.library.http.network;
...
public class Network {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            Elog.i(TAG, "-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            Elog.i(TAG, "getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    Elog.i(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    Elog.i(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    Elog.i(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    Elog.i(TAG, "NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                Elog.i(TAG, "\n");
            } else {
                Elog.i(TAG, "getAllNetworkInfo is null");
            }
        }
        return false;
    }
