package com.elt.framework.library.http.impl.apache;

import com.elt.framework.library.http.data.Consts;
import com.elt.framework.library.http.exception.HttpClientException;
import com.elt.framework.library.http.impl.apache.entity.FileEntity;
import com.elt.framework.library.http.impl.apache.entity.InputStreamEntity;
import com.elt.framework.library.http.impl.apache.entity.MultipartEntity;
import com.elt.framework.library.http.request.AbstractRequest;
import com.elt.framework.library.http.request.content.ByteArrayBody;
import com.elt.framework.library.http.request.content.FileBody;
import com.elt.framework.library.http.request.content.HttpBody;
import com.elt.framework.library.http.request.content.InputStreamBody;
import com.elt.framework.library.http.request.content.StringBody;
import com.elt.framework.library.http.request.content.multi.MultipartBody;
