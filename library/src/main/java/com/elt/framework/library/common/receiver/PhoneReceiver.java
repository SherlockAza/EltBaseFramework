...
import com.elt.framework.library.common.CommonUtils;
import com.elt.framework.library.common.log.Elog;

/**
 * 作者：addison on 8/1/16 11:22
...
public class PhoneReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (NEW_OUTGOING_CALL.equals(intent.getAction())) {
            ...
            if (!CommonUtils.isEmpty(inNumber)) {
