package com.elt.framework.library.common.assist;
...
import com.elt.framework.library.common.utils.ShellUtil;

import java.io.File;

/**
 * 作者：addison on 8/1/16 10:44
 * 邮箱：gengxin@elongtian.com
 * 安装器， 静默安装、卸载（仅在root过的手机上）
 */
